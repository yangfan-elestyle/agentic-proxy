...
/// - payload 明文: `{"https://api.openai.com/auth":{"chatgpt_account_id":"agentic-proxy"}}`
/// - 三段 base64 都落在标准与 url-safe 字母表的交集 (无 `+` `/` `-` `_`) -> 两种解码器都能读
pub const CLIENT_API_KEY: &str = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJodHRwczovL2FwaS5vcGVuYWkuY29tL2F1dGgiOnsiY2hhdGdwdF9hY2NvdW50X2lkIjoiYWdlbnRpYy1wcm94eSJ9fQ.agenticproxy";
